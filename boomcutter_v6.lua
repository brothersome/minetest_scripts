...
if not st then
	...
	move_two_backward_top = function()
		move.backward()
		move.backward()
		dir = -1
		vertical_cnt = 0
	...
	if dir == -2 then
		...
		self.label(string.format('In operation: %d: %d, %d, %d, %d, %d, %1.2f', treenumber, dir, operationdir, levelcheck_cnt, level_smelt, level_power, currentEnergy))
